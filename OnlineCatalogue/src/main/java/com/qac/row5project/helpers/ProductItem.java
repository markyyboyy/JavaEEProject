...
public class ProductItem {
	 ...
	 * @param price
	 */
	public ProductItem(long id, String name, String desc, double size, double weight, ItemStatus status,
			long supplierID, Category category) {
		this.ID = id;
		this.name = name;
		this.desc = desc;
		this.weight = weight;
	 ...
	 * @param weight
	 */
	public void addProductInfo(long id, String name, String desc, double size, double weight, ItemStatus status,
			long supplierID, Category category) {
		this.ID = id;
		this.name = name;
		this.desc = desc;
